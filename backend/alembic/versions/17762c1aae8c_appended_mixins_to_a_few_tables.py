...
def upgrade() -> None:
    ...
    op.add_column('menus', sa.Column('created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    op.add_column('menus', sa.Column('updated_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False))
    op.add_column('menus', sa.Column('created_by', sa.Uuid(), nullable=True))
    ...
    op.add_column('menus', sa.Column('deleted_at', sa.DateTime(timezone=True), nullable=True))
    op.add_column('menus', sa.Column('deleted_by', sa.Uuid(), nullable=True))
    ...
    op.create_index(op.f('ix_menus_updated_by'), 'menus', ['updated_by'], unique=False)
