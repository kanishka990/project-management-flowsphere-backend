...
@router.post(
    ...
    dependencies=[Depends(require_permission("submenus:create"))]
)
...
@router.get(
    ...
    dependencies=[Depends(require_permission("submenus:read"))]
)
...
@router.delete(
    ...
    dependencies=[Depends(require_permission("submenus:delete"))]
)
